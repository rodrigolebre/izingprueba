<template>
  <div v-if="userProfile === 'admin'">
    <q-list class="text-weight-medium">
      ...
      >
        <q-item-section>
          <q-item-label> Para usar Dialogflow necessário fazer pagamento acesso api a empresa google.</q-item-label>
        </q-item-section>
      </q-item>
    </q-list>
	<center><a href="https://cloud.google.com/dialogflow/pricing?hl=pt-br" target="_blank">https://cloud.google.com/dialogflow/pricing?hl=pt-br</a></center>
  </div>
</template>
