<template>
  <div v-if="userProfile === 'admin'">
    <q-list class="text-weight-medium">
      ...
      >
        <q-item-section>
          <q-item-label> Para usar ChatGPT necessário fazer pagamento acesso api a empresa openai.</q-item-label>
        </q-item-section>
      </q-item>
    </q-list>
	<center><a href="https://openai.com/pricing" target="_blank">https://openai.com/pricing</a></center>
  </div>
</template>
