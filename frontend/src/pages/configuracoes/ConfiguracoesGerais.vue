    ...
    <q-list class="text-weight-medium">
      ...
      <!-- <q-item tag="label" v-ripple>
        <q-item-section>
          ...
          <q-item-label caption> Esse comando para o serviço. Após executá-lo você precisa reiniciar usa VPS através do terminal. </q-item-label>
        </q-item-section>
        <q-btn  @click="clean"
            flat
            icon="mdi-replay"
...
import { ListarTenantPorId, AlterarTenantShowChatbot, AlterarTenantNullTickets, AlterarTenantTentativas, AlterarTenantFixarConexoes, AlterarTenantForcarAdmin } from 'src/service/tenants'
