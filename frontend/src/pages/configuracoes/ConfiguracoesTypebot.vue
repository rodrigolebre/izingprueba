...
<!-- 
      ...
      >
        <q-item-section>
          <q-item-label>Typebot modelo de bot externo com possibilidade de integração com sistemas. Necessário serviço externo</q-item-label>
        </q-item-section>
      </q-item>
    </q-list>
	<center><a href="https://typebot.io/" target="_blank">https://typebot.io/</a></center>
  </div>
</template>
