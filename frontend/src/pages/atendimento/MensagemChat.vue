      ...
      <div v-for="(mensagem, index) in mensagens" :key="`mensagem-${index}`">
        ...
        >
          ...
          <div style="min-width: 100px; max-width: 350px" :style="mensagem.isDeleted ? 'color: rgba(0, 0, 0, 0.36) !important;' : ''">
            ...
            <template style="margin-top:20px" v-if="!['audio', 'vcard', 'image', 'video', 'sticker', 'location', 'interactive', 'button', 'list', 'button_reply', 'sticker', 'notes'].includes(mensagem.mediaType) && mensagem.mediaUrl">
            ...
            <div
              ...
              v-linkified
              v-if="!['vcard', 'application', 'audio', 'button', 'list', 'location', 'interactive', 'button_reply', 'sticker', 'notes', 'templates'].includes(mensagem.mediaType)"
