import { AtualizarStatusTicket, EnviarMensagemTexto, LocalizarMensagens, AtualizarTicket} from 'src/service/tickets'
  ...
  methods: {
    ...
    async atualizarStatusTicket (status) {
      ...
      this.$q.dialog(dialogOptions).onOk(async (data) => {
        ...
        if(this.ticketFocado.whatsapp.sendEvaluation === 'enabled' && (this.ticketFocado.channel === 'whatsapp' || this.ticketFocado.channel === 'waba')){
          try{
