    ...
    <div class="q-my-md">
      ...
      >
        ...
        <q-list class="text-weight-medium">       
          ...
          <div class="col-12">
            <q-btn rounded label="Listar Participantes" @click="enviar" color="primary" style="margin-bottom: 15px;margin-right: 5px;"/>
            <q-btn rounded label="Exportar para XLS" @click="exportDataToXLS" color="primary" style="margin-bottom: 15px;margin-right: 5px;"/>
