<template>
  <div v-if="userProfile === 'admin'">
    <div class="row col q-pa-md justify-between items-center btn-fundodash" >
      <h1> Painel de Atendimentos </h1>
      <q-btn	    
        icon="mdi-filter"
        style="background-color: #29b3a3; border: none; box-shadow: none; color: white;"
        flat
        label="Filtros"
      ...
      <div class="q-mb-md">
        ...
        <q-btn @click="fecharTicketsAbertos"
            style="background-color: #bbbd10; border: none; box-shadow: none; color: white;"            
            flat
            class="">
        ...
        <q-btn @click="fecharTicketsPendentes"
            style="background-color: #1a86c4; border: none; box-shadow: none; color: white;"
            flat
            class="">
      ...
      <q-card class="q-pa-md"
        ...
        <q-card-actions align="right">
          <q-btn
            flat
            label="Sair"
            style="background-color: #d44c57; border: none; box-shadow: none; color: white;"
            v-close-popup
            class="q-mr-lg" />
          <q-btn
            flat
