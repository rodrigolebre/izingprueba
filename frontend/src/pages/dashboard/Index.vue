<template>
  <div class="q-pa-sm btn-fundodash">
    <q-card class="q-my-md btn-painel">
    ...
    <q-card class="q-my-md q-pa-sm btn-painelcinza">
        ...
        <div class="row q-gutter-md justify-center">
          <div class="col-xs-12 col-sm-shrink">
           <q-card
              ...
              style="min-width: 200px; background-color: #1a86c4; color: white; border-radius: 0; box-shadow: none"
            >
          ...
          <div class="col-xs-12 col-sm-shrink">
           <q-card
              flat
              class="my-card full-height"
              style="min-width: 200px; background-color: #8951db; color: white; border-radius: 0; box-shadow: none"
            >
              <q-card-section class="text-center">
                <div class="row items-center">
                  <div class="col">
          ...
          <div class="col-xs-12 col-sm-shrink">
            <q-card
              flat
              class="my-card full-height"
              style="min-width: 200px; background-color: #2c8d9c; color: white; border-radius: 0; box-shadow: none"
            >
              <q-card-section class="text-center">
                <div class="row items-center">
                  <div class="col">
          ...
          <div class="col-xs-12 col-sm-shrink">
            <q-card
              flat
              class="my-card full-height"
              style="min-width: 200px; background-color: #d44c57; color: white; border-radius: 0; box-shadow: none"
            >
              <q-card-section class="text-center">
                <div class="row items-center">
                  <div class="col">
          ...
          <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
            <q-card
              flat
             class="my-card full-height" style="background-color: #de9a33; color: white; border-radius: 0; box-shadow: none">
              <q-card-section class="text-center">
          ...
          <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
            <q-card flat class="my-card full-height" style="background-color: #29b3a3; color: white; border-radius: 0; box-shadow: none">
              <q-card-section class="text-center">
                <p class="text-h5 text-bold text-center">
    ...
    <div class="row q-col-gutter-md">
      <div class="col-xs-12 col-sm-6">
        <q-card class="q-pa-md btn-painelcinza">
          <q-card-section class="q-pa-md btn-painelcinza">
            <ApexChart
    ...
    <q-card class="q-my-md btn-painelcinza">
      <q-card-section>
        <ApexChart
    ...
    <q-card class="q-my-md q-pa-sm btn-painelcinza" v-if="toggleValue === false">
      <q-card-section class="q-pa-md btn-painelcinza">
        <q-table
...
.btn-laranja {
  background-color: #de9a33; /* Define a cor de fundo como cinza */
