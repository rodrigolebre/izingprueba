  ...
  >
    <q-card class="q-pa-md">
      ...
      <q-card-actions align="right" class="q-mt-lg">
        <q-btn rounded flat label="Sair" color="negative" v-close-popup class="q-px-md" />
        <q-btn rounded class="q-ml-lg q-px-md" flat label="Salvar" color="primary" @click="saveContact" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
