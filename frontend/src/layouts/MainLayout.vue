              ...
              <q-list style="min-width: 300px">
                <!--q-item>
                  <q-item-section
                    ...
                    {{ parseInt(notificacaoInternaNaoLida) }} + {{ parseInt(notifications_p.count) }}
                  </q-item-section>
                </q-item-->
                <q-item v-if="(parseInt(notificacaoInternaNaoLida) + parseInt(notifications_p.count)) == 0">
...
export default {
  ...
  computed: {
    ...mapGetters(['notifications', 'notifications_p', 'whatsapps', 'showMenu', 'chatFocado', 'notificacaoChatPrivado', 'notificacoesChat', 'notificacaoTicket']),
    cProblemaConexao () {
